Namespace Dashboard_OlapDataProvider
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.pieLabelPositionBarItem1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {
				New DevExpress.XtraBars.LinkPersistInfo(Me.pieLabelPositionOutsideBarItem1),
				New DevExpress.XtraBars.LinkPersistInfo(Me.pieLabelPositionInsideBarItem1)
			})
